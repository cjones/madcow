...
class MyOSCARConnection(BOSConnection):
    # this class is kinda useless now. receiveMessage and initDone
    # are the on
...
# XXX are any of these ever used?
...
def main():
    ...
    # merge modules that inherit from each other
    ...
    aim = AIMClient('madcowbot4', 'rover42', 'hi')
    aim.start()
    return 0
